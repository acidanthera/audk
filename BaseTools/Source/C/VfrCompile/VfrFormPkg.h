...
public:
  ...
  EFI_VFR_RETURN_CODE
  BuildPkgHdr (
    OUT EFI_HII_PACKAGE_HEADER **
    );

  EFI_VFR_RETURN_CODE
  BuildPkg (
    IN FILE *,
    IN PACKAGE_DATA  *PkgData = NULL
    );
...
public:
  ...
  VOID
  IfrUpdateRecordInfoForDynamicOpcode (
    IN BOOLEAN
    );

  VOID
  IfrCheckAddDefaultRecord (
    IN BOOLEAN,
    IN BOOLEAN
    );
  ...
  VOID
  IfrCreateDefaultForQuestion (
    IN  SIfrRecord *,
    IN  QuestionDefaultRecord *
    );

  VOID
  IfrParseDefaulInfoInQuestion (
    IN  SIfrRecord *,
    OUT QuestionDefaultRecord *
    );

  VOID
  IfrAddDefaultToBufferConfig (
    IN  UINT16,
    IN  SIfrRecord *,
...
public:
  CIfrObj (
           IN UINT8    OpCode,
           OUT CHAR8   **IfrObj  = NULL,
           IN UINT8    ObjBinLen = 0,
           IN BOOLEAN  DelayEmit = FALSE
           );
  virtual
  ~CIfrObj(
           VOID
...
public:
  ...
  VOID
  UpdateCIfrQuestionHeader (
    IN EFI_IFR_QUESTION_HEADER  *Header
    )
  {
    mHeader = Header;
  }
...
public:
  CIfrMinMaxStepData (
                      MINMAXSTEP_DATA  *DataAddr,
                      BOOLEAN          NumericOpcode = FALSE
  ...
  VOID
  UpdateCIfrMinMaxStepData (
    IN MINMAXSTEP_DATA  *MinMaxStepData
    )
  {
...
public:
  CIfrFormSet (
               UINT8  Size
               ) : CIfrObj (EFI_IFR_FORM_SET_OP, (CHAR8 **)NULL, Size),
...
public:
  CIfrDefaultStore (
                    ) : CIfrObj (EFI_IFR_DEFAULTSTORE_OP),
...
public:
  CIfrFormMap (
               ) : CIfrObj (EFI_IFR_FORM_MAP_OP, (CHAR8 **)NULL, sizeof (EFI_IFR_FORM_MAP), TRUE),
  ...
  VOID
  SetFormMapMethod (
    IN EFI_STRING_ID  MethodTitle,
    IN EFI_GUID       *MethodGuid
    )
  {
...
public:
  CIfrVarStore (
                ) : CIfrObj (EFI_IFR_VARSTORE_OP, (CHAR8 **)NULL, sizeof (EFI_IFR_VARSTORE), TRUE),
...
public:
  CIfrVarStoreEfi (
                   ) : CIfrObj (EFI_IFR_VARSTORE_EFI_OP, (CHAR8 **)NULL, sizeof (EFI_IFR_VARSTORE_EFI), TRUE),
...
public:
  CIfrVarStoreNameValue (
                         ) : CIfrObj (EFI_IFR_VARSTORE_NAME_VALUE_OP),
...
public:
  CIfrRef2 (
            ) : CIfrObj (EFI_IFR_REF_OP, (CHAR8 **)NULL, sizeof (EFI_IFR_REF2)),
...
public:
  CIfrRef3 (
            ) : CIfrObj (EFI_IFR_REF_OP, (CHAR8 **)NULL, sizeof (EFI_IFR_REF3)),
...
public:
  CIfrRef4 (
            ) : CIfrObj (EFI_IFR_REF_OP, (CHAR8 **)NULL, sizeof (EFI_IFR_REF4)),
...
public:
  CIfrResetButton (
                   ) : CIfrObj (EFI_IFR_RESET_BUTTON_OP),
...
public:
  CIfrNumeric (
               ) : CIfrObj (EFI_IFR_NUMERIC_OP, (CHAR8 **)NULL, sizeof (EFI_IFR_NUMERIC), TRUE),
...
public:
  CIfrOneOf (
             ) : CIfrObj (EFI_IFR_ONE_OF_OP, (CHAR8 **)NULL, sizeof (EFI_IFR_ONE_OF), TRUE),
...
public:
  CIfrOrderedList (
                   ) : CIfrObj (EFI_IFR_ORDERED_LIST_OP),
...
public:
  CIfrSuppressIf (
                  ) : CIfrObj (EFI_IFR_SUPPRESS_IF_OP),
...
public:
  CIfrGrayOutIf (
                 ) : CIfrObj (EFI_IFR_GRAY_OUT_IF_OP),
...
public:
  CIfrInconsistentIf (
                      ) : CIfrObj (EFI_IFR_INCONSISTENT_IF_OP),
...
public:
  CIfrNoSubmitIf (
                  ) : CIfrObj (EFI_IFR_NO_SUBMIT_IF_OP),
...
public:
  ...
  VOID
  SetRefreshEventGroutId (
    IN EFI_GUID  *RefreshEventGroupId
    )
  {
...
public:
  CIfrVarStoreDevice (
                      ) : CIfrObj (EFI_IFR_VARSTORE_DEVICE_OP),
...
public:
  CIfrOneOfOption (
                   UINT8  Size
                   ) : CIfrObj (EFI_IFR_ONE_OF_OPTION_OP, (CHAR8 **)NULL, Size),
...
public:
  CIfrClass (
             ) : CIfrObj (EFI_IFR_GUID_OP, (CHAR8 **)NULL, sizeof (EFI_IFR_GUID_CLASS)),
...
public:
  CIfrSubClass (
                ) : CIfrObj (EFI_IFR_GUID_OP, (CHAR8 **)NULL, sizeof (EFI_IFR_GUID_SUBCLASS)),
...
public:
  CIfrLabel (
             ) : CIfrObj (EFI_IFR_GUID_OP, (CHAR8 **)NULL, sizeof (EFI_IFR_GUID_LABEL)),
...
public:
  CIfrBanner (
              ) : CIfrObj (EFI_IFR_GUID_OP, (CHAR8 **)NULL, sizeof (EFI_IFR_GUID_BANNER)),
...
public:
  CIfrTimeout (
               IN UINT16  Timeout = 0
               ) : CIfrObj (EFI_IFR_GUID_OP, (CHAR8 **)NULL, sizeof (EFI_IFR_GUID_TIMEOUT)),
...
public:
  CIfrGuid (
            UINT8  Size
            ) : CIfrObj (EFI_IFR_GUID_OP, (CHAR8 **)NULL, sizeof (EFI_IFR_GUID)+Size),
