...
if (MachineType == EFI_IMAGE_MACHINE_IA32 || MachineType == EFI_IMAGE_MACHINE_X64) {
  ...
  } else if (MachineType == EFI_IMAGE_MACHINE_ARMTHUMB_MIXED) {
    //
...
--*/
{
  ...
  if (MachineType == EFI_IMAGE_MACHINE_ARMTHUMB_MIXED) {
...
--*/
{
  ...
  *MachineType = UefiImageGetMachine (&Context);
  ...
  if ((*MachineType != EFI_IMAGE_MACHINE_IA32) &&  (*MachineType != EFI_IMAGE_MACHINE_X64) && (*MachineType != EFI_IMAGE_MACHINE_EBC) &&
      (*MachineType != EFI_IMAGE_MACHINE_ARMTHUMB_MIXED) && (*MachineType != EFI_IMAGE_MACHINE_AARCH64) &&
...
--*/
{
  ...
  for (Index = 1;; Index++) {
    ...
    if (!EFI_ERROR(Status)) {
      ...
      if ((MachineType == EFI_IMAGE_MACHINE_ARMTHUMB_MIXED) || (MachineType == EFI_IMAGE_MACHINE_AARCH64)) {
...
--*/
{
  ...
  for (Index = 1;; Index++) {
    ...
    if ( (Machine == EFI_IMAGE_MACHINE_ARMTHUMB_MIXED) ||
         (Machine == EFI_IMAGE_MACHINE_AARCH64) ) {
      mArm = TRUE;
    }

    if (Machine == EFI_IMAGE_MACHINE_RISCV64) {
      mRiscV = TRUE;
    }

    if (Machine == EFI_IMAGE_MACHINE_LOONGARCH64) {
      mLoongArch = TRUE;
    }
