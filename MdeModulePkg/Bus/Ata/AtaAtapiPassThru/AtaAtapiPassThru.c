  ...
  )
{
  ...
  if ((This->Mode->IoAlign > 1) && !ADDR_IS_ALIGNED (Packet->InDataBuffer, This->Mode->IoAlign)) {
    return EFI_INVALID_PARAMETER;
  }

  if ((This->Mode->IoAlign > 1) && !ADDR_IS_ALIGNED (Packet->OutDataBuffer, This->Mode->IoAlign)) {
    return EFI_INVALID_PARAMETER;
  }

  if ((This->Mode->IoAlign > 1) && !ADDR_IS_ALIGNED (Packet->Asb, This->Mode->IoAlign)) {
    return EFI_INVALID_PARAMETER;
  }
  ...
  )
{
  ...
  if ((This->Mode->IoAlign > 1) && !ADDR_IS_ALIGNED (Packet->SenseData, This->Mode->IoAlign)) {
    return EFI_INVALID_PARAMETER;
  }
